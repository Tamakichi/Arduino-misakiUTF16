...
2025/11/19 更新 v1.31  
・サンプルスケッチbannarのシリアル出力の不具合対応（ネイティブUSBボード対応）    
...
クリックして、さらに「Dounload ZIP」にてダウンロードします。
![download](img/download.png)  

ダウンロード後、Arduino IDEの  
「スケッチ」＞「ライブラリをインクルード」＞「ZIP形式のライブラリをインストール...」にてダウンロードしたZIPファイルを指定します。  
